...
import { FaCircleCheck, FaCircleXmark, FaTriangleExclamation, FaMicrochip, FaDisplay, FaVideo } from "react-icons/fa6";
import type {
    DiagnosticsReport,
...
const StatusIndicator: React.FC<StatusIndicatorProps> = ({ supported, label, hardwareAccelerated }) => {
    const getIcon = () => {
        if (!supported) {
...
export const DiagnosticsPanel: React.FC = () => {
    ...
    const [testResults, setTestResults] = useState<DiagnosticsTestResults | null>(null);
    ...
    const renderSummaryTab = () => {
        ...
        const data = summary || {
            av1Support: report?.codecs.av1.decode4K || report?.codecs.av1.decode1080p || false,
            hevcSupport: report?.codecs.hevc.decode4K || report?.codecs.hevc.decode1080p || false,
            h264Support: report?.codecs.h264.decode1080p || false,
            max4K: report?.codecs.av1.decode4K || report?.codecs.hevc.decode4K || false,
            ...
            <div className="space-y-4">
                ...
                <div className="bg-gray-700 rounded p-3">
                    ...
                    <div className="space-y-1">
                        <StatusIndicator supported={data.av1Support} label="AV1 (4K Streaming)" />
                            ...
                            {gpu.features.map((feature, i) => (
                                <div key={i} className="flex justify-between text-sm">
                                    ...
                                    <span className={
                                        ...
                                        feature.status === "software" ? "text-yellow-400" :
                                        feature.status === "disabled" ? "text-red-400" :
                                        "text-gray-500"
                                    }>
                                        {feature.status}
                                    </span>
